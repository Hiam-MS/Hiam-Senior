...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>S<span>PM</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="img/ui-sam.jfif" class="img-circle" width="80"></a></p>
          <h5 class="centered">Consultant </h5>
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                @csrf
                  <tr>
                    ...
                    <th><i class=" fa fa-edit"></i> To</th>
                    <th><i class=" fa fa-edit"></i> Subject</th>
                    <th><i class=" fa fa-edit"></i> Rev.</th>
                    <th><i class=" fa fa-edit"></i> Issue Date</th>
                    <th><i class=" fa fa-edit"></i> Internal Submitted To</th>
                    <th><i class=" fa fa-edit"></i> Internal Submitted Date</th>
                    <th><i class=" fa fa-edit"></i> Internal Returned Date</th>
                    <th><i class=" fa fa-edit"></i> Returned Date</th>
